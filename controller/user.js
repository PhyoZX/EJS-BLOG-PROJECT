...
const stripe = require("stripe")("sk_test_51ODojxAUUxl6HZ3pKtvcAQczajwfR2CIBWCRwkKATmWZtyuR3wDSLwgwC8uyONrMCx8k8wU8IjVpNVyHvXnFzRKc00ZYAtsNyg");
...
exports.renderPremiumPage = (req,res,next) =>{
    stripe.checkout.sessions.create({
        ...
        line_items : [
            {
                price : "price_1ODqqQAUUxl6HZ3p493PjB4E",
                quantity : 1,
            }
        ],
        mode : "subscription",
...
exports.getSuccessPage = (req,res) =>{
    ...
    .then(()=>{
        res.render("user/subscription-success",{ title : "Subscription success" })
    })
    .catch((err)=>{
        console.log(err);
        const error = new Error("Something went wrong.");
